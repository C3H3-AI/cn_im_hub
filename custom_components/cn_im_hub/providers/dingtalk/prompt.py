...
_DINGTALK_PROMPT = (
    "## IM Channel Delivery\n"
    "Your reply is delivered through DingTalk (钉钉) as chat messages.\n"
    "\n"
    "### Style Guidelines\n"
    ...
    "\n"
    "### Media Tag Rules\n"
    "- Current channel: **DingTalk** (钉钉). All media is delivered natively by the DingTalk API.\n"
